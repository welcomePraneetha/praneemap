"use strict";
	var precacheConfig=[
		["/index.html","dc211a4458d49f2e0acc0792b7e7a48b"],
		["/static/css/main.8a736434.css","c0410ba516f62a4de8ac32b44072084b"],
		["/static/js/main.cd5e10e3.js","6a29186750c4ad41c37b7deb46fe7f2b"]
	],
	...
	urlsToCacheKeys=new Map(precacheConfig.map(function(e) {
		var t=e[0],n=e[1],r=new URL(t,self.location),
	...
	self.addEventListener("fetch",function(e) {
		if("GET"===e.request.method) {
			...
			var a="/index.html";
			!t&&"navigate"===e.request.mode&&isPathWhitelisted(["^(?!\\/__).*"],e.request.url)&&(n=new URL(a,self.location).toString(),
